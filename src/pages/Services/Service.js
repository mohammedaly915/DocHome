...
const Service = ({setsidebar}) => {
  ...
  return (
    <section id="services" className="min-h-[87vh] flex justify-center items-center py-5 mt-5 bg-light">
      <div className="w-11/12 max-w-4xl bg-white rounded-3xl shadow p-6">
        <div className="flex items-center mb-5 p-3 cursor-pointer" onClick={handleBack}>
